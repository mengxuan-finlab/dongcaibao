...
# 一、核心摘要
請用 4-6 句完成，總字數 220-320 字。
必須回答：
1. ${symbol} 是誰，主要解決什麼問題？
2. 它主要靠什麼產品 / 服務賺錢？
3. 它的商業模式為什麼有特色？
4. 近期最重要的成長動能與壓力是什麼？
5. 本篇接下來會聚焦哪些觀察點？
...
# 二、基本介紹
## 基本資訊（公司歷史、願景、產品簡介）
先用一小段自然文字帶出：「這家公司是怎麼一步步走到現在的？」

### 1. 公司發展時間線
請整理 4-6 個關鍵時間點。每個時間點格式如下：
- **年份 / 時期**：發生了什麼事？這件事對公司後續發展代表什麼？

如果資料沒有完整年份，可以用「早期發展」、「近年發展」、「最新發展」代替。
...
| 服務領域 | 核心產品類型 | 產品 / 服務範例 | 對公司的意義 |
| :--- | :--- | :--- | :--- |

## ${symbol} 怎麼做生意？
請用「核心模式 → 產品策略 → 技術 / 營運能力」三層拆解。

### 1. 核心營運模式
用 3-5 個步驟說明客戶從接觸公司、購買產品 / 服務、到持續付費的流程。

| 步驟 | 公司做了什麼 | 客戶體驗優勢 | 對營收 / 留存的影響 |
| :--- | :--- | :--- | :--- |

### 2. 產品策略：從哪個痛點切入，又如何擴張？

| 領域 | 產品定位與特點 | 戰略意義 |
| :--- | :--- | :--- |

### 3. 技術、平台或營運效率
說明公司是否透過軟體、AI、資料、供應鏈、通路、品牌、訂閱制、垂直整合等方式提升效率。
若沒有相關資訊，請寫「目前資料不足以判斷」。

## 商業模式：收入怎麼來？
### 1. 核心收入來源與付費方式
- **誰付錢**：
- **為什麼願意付錢**：
- **怎麼付錢**：（一次性 / 訂閱 / 用量制 / 抽成 / 混合模式）
- **收入是否可預測**：
- **是否具備交叉銷售或提高客單價的機會**：

### 2. 成本結構與毛利特性

| 成本要素 | 公司可能的優勢 / 壓力 | 對財務的影響 |
| :--- | :--- | :--- |

## ${symbol} 的競爭優勢：它憑什麼贏？
請整理 3-5 個真正可驗證的優勢。每個優勢都要包含「厲害在哪」和「跟別人有什麼不同」。

### 1. 競爭優勢總覽

| 優勢來源 | 厲害在哪 | 跟競爭者的差異 | 可追蹤指標 |
| :--- | :--- | :--- | :--- |

### 2. 護城河分類
請標註每個優勢屬於哪種類型：品牌 / 無形資產 / 轉換成本 / 成本優勢 / 網路效應 / 規模經濟 / 資料優勢 / 通路優勢。

## ${symbol} 的潛在風險
請列出 3-5 個具體風險，不要只寫標題。每個風險都要說明「發生原因、可能影響、投資人該追蹤什麼」。

| 風險 | 為什麼重要 | 可能影響的財務或營運指標 | 追蹤方式 |
| :--- | :--- | :--- | :--- |

# 三、產業與競爭
## 1. 產業位置與市場機會
用白話說明這家公司所在市場的成長原因、主要需求、滲透率或週期性。
如果有特定成長主題，請明確寫出，例如：AI、雲端、GLP-1、電動車、資安、線上醫療、廣告復甦等。
...
- **營收成長**：
- **毛利率 / 獲利能力**：
- **訂閱數 / 客戶數 / 用戶數 / 出貨量等營運指標**：
- **現金流與資本支出**：
- **資產負債表健康度**：

若缺少精確數字，請明確寫「未披露」，但仍可說明該指標為何重要。

## 產業與競爭力分析
整理這家公司未來 1-3 年最重要的成長變數與競爭變數。

| 關鍵變數 | 為什麼重要 | 正面訊號 | 負面訊號 |
| :--- | :--- | :--- | :--- |
...
## 3. 懂才抱財報閱讀指南
請依照「懂才抱財報分析框架」，從以下可用指標中，挑選 6-10 個對該公司最具分析價值的核心指標。
...
# 六、關鍵新訊追蹤清單（News Monitoring Tags）
