...
資訊不足時填入「未披露」，禁止使用空字串，也不要在後方 Markdown 報告重複輸出核心摘要。
<!-- CORE_SUMMARY_START -->
...
資料不足時填入「未披露」，禁止捏造產品名稱，也不要在後方 Markdown 報告重複輸出主要產品與服務。
...
# 二、基本介紹
## 基本資訊（公司歷史、願景、產品簡介）
公司歷史已由前方的 TIMELINE JSON 轉為視覺化時間軸，Markdown 報告中不要再次輸出時間線或公司歷史段落。
