...
## 2. 財報追蹤重點 (Financial Focus)
請針對該公司的產業特性，從「三大財報表」中挑選 6-10 個最關鍵的追蹤指標。
請將指標分類為：
- **損益表 (Income Statement)**：關注獲利能力與增長動能。
- **資產負債表 (Balance Sheet)**：關注財務健康度與資產效率。
- **現金流量表 (Cash Flow Statement)**：關注真實含金量與投資佈局。
每個指標須說明「為什麼重要」以及「在財報中對應的項目名稱」。
